...
\newcommand{\assunto}{GestorPsi}			%Nome do experimento
\newcommand{\ver}{\assunto}						%numeração do experimento
\newcommand{\professor}{Luiz Carlos Miyadaira}
\newcommand{\curso}{ENGENHARIA DE SOFTWARE}
\newcommand{\turma}{D}

%%------------------------------------------------------------------------------
%%------------------------Detalhes para serem revistos--------------------------
\newcommand{\keyw}{Measurement and Analysis, Métricas, \assunto}	%Keywords
...
\newcommand{\ziul}{{Luiz Oliveira}}					%Sem link
\newcommand{\carlos}{{Carlos Henrique Ferreira Oliveira}}					%Sem link
\newcommand{\carloss}{{Carlos Oliveira}}					%Sem link
\newcommand{\rafael}{{Rafael Fazzolino}}					%Sem link
\newcommand{\luizmatricula}{10/46969}
\newcommand{\carlosmatricula}{10/0048021}
...
{
	\newcommand{\names}{\luiz~-~\luizmatricula\\\carlos~-~\carlosmatricula\\\rafael~-~\rafaelmatricula}
	% \newcommand{\allmatriculas}{\luizmatricula,\carlosmatricula,\rafaelmatricula}
